...
export const HomeDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* 3. RECENT AUDIT HISTORY (DB-BACKED — CLICKABLE FULL WIDTH) */}
        ...
        <div className={`w-full p-6 rounded-2xl border ${
          ...
          {recentAudits.length > 0 ? (
            <div className="space-y-3">
              {recentAudits.map((scan) => (
                <button
                  ...
                  className={`w-full p-4 rounded-xl border transition-all text-left flex items-center justify-between group cursor-pointer ${
                    isDark
            ...
            <div className={`p-8 rounded-2xl border text-center space-y-3 ${
              ...
              <button
                onClick={() => navigate('/audit')}
                className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs shadow-md transition-all inline-flex items-center gap-1.5 cursor-pointer"
              >

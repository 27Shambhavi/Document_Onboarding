...
export const ProjectDetailDashboard: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="space-y-4 animate-fade-in">
          <div className="flex items-center justify-between">
            ...
            {allocatedCount < teamCapacity && (
              <button
                onClick={() => setActiveTab('scan')}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold transition-colors cursor-pointer shadow-sm"
              >
      ...
      {/* SECTION 2: CANDIDATE EVALUATION & SCANNING */}
      {activeTab === 'scan' && (
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
              ...
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold shadow-md shadow-indigo-500/20 disabled:opacity-50 transition-all cursor-pointer"
              >
                {isRanking ? (
                  <>
